...
#  [Author]
#
#  Anurag aka Adroit Anurag
#  Adroit.Anurag [at] Instagram [dot] Com
#  http://github.com/AdroitAnurag
#  http://hackerone.com/adroitanurag
#
#  [License]
#
...
def print_cow():
    print(" ___________ ")
    print(" \033[07m  wist.py! \033[27m                # Common")
    print("      \                     # User")
    print("       \   \033[1;31m,__,\033[1;m             # Passwords")
    print("        \  \033[1;31m(\033[1;moo\033[1;31m)____\033[1;m         # Profiler")
    print("           \033[1;31m(__)    )\ \033[1;m  ")
    print(
        "           \033[1;31m   ||--|| \033[1;m\033[05m*\033[25m\033[1;m      [ Adroit Anurag | https://github.com/AdroitAnurag ]"
    )
    print(28 * " " + "[ Anonymous Dude | https://github.com/AnonymousDude4444/]\r\n")


def version():
    """Display version"""

    print("\r\n	\033[1;31m[ wist.py ]  " + __version__ + "\033[1;m\r\n")
    print("	* Hacked up by Anurag Bala")
    print("	* http://github.com\AdroitAnurag\r\n")
...
def improve_dictionary(file_to_open):
    ...
    if leetmode == "y":
        for (
            ...
            unique_lista
        ):  # if you want to add more leet chars, you will need to add more lines in wist.cfg too...
    ...
    print_to_file(file_to_open + ".wist.txt", unique_list_finished)
...
# the main function
def main():
    """Command-line interface to the wist utility"""

    read_config(os.path.join(os.path.dirname(os.path.realpath(__file__)), "wist.cfg"))
